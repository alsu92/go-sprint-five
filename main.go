...
// meanSpeed возвращает среднюю скорость бега или ходьбы в кч/ч.
...
func (w Walking) Calories() float64 {
	...
	meanSpeed := math.Pow(meanSpeedInSec, 2) / (w.Height / CmInM)
	return ((CaloriesWeightMultiplier*w.Weight + meanSpeed*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
}
